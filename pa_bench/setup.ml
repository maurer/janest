(* OASIS_START *)
(* DO NOT EDIT (digest: 4db59f476021076ce7cc2999a7df8b99) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/pa_bench";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Benchmark_accumulator"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "pa_bench";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "pa_bench_syntax";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Pa_bench"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "pa_bench_lib";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "`\238\239\245\138\141\024X\147\241tDo7\195\246";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
