(* OASIS_START *)
(* DO NOT EDIT (digest: 9726f752adb93cddb3b60ab32c173041) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/variantslib";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "variantslib";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "pa_variants_conv";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Pa_variants_conv"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "variantslib";
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "c\002\203\021h\217F1\171\248\206\019\175\222\156\202";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
