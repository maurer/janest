(* OASIS_START *)
(* DO NOT EDIT (digest: 20548d0ea2a89b661e3dca07c8a6c3b9) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "pa_ounit";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "pa_ounit_syntax";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Pa_ounit"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "pa_ounit_lib";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "5\252\002\161\192\001&\248\156\n\231T?\135s\192";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
