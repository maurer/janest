(* OASIS_START *)
(* DO NOT EDIT (digest: 9539a2ddac3da37b8d7f2407a1d35d94) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Ascii_table"; "Console"; "Std"; "Text_graph"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "textutils";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\216\2064/\253\197\253_f\019\176t,\201\129{";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
