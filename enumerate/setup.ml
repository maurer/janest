(* OASIS_START *)
(* DO NOT EDIT (digest: 09941a1d8a9e83c59f68a477e293db77) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights =
            [
               "(C) 2009-2014 Jane Street Capital LLC <opensource@janestreet.com>"
            ];
          maintainers =
            ["Jane Street Capital LLC <opensource@janestreet.com>"];
          authors = ["Jane Street Capital LLC <opensource@janestreet.com>"];
          homepage = Some "https://github.com/janestreet/enumerate";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pa_enumerate"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "syntax";
                      lib_findlib_containers = ["enumerate"]
                   })
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\195\rU\130\162DJzb\203\170f\214\133\154\253";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
