(* OASIS_START *)
(* DO NOT EDIT (digest: b812f423d9e03bed5c28a83e2becba71) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/async_find";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Async_find"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "async_find";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\028\015\146\233%\217(=%\023Z\129\187\138\n\241";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
