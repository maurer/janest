(* OASIS_START *)
(* DO NOT EDIT (digest: 05e49fb8fba7656c513a0aec898faf3f) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/re2";
          ...
          build_custom =
            {
               pre_command =
                 [(OASISExpr.EBool true, Some (("./_prebuild", [])))];
               post_command = [(OASISExpr.EBool true, None)]
            };
                      ...
                      Some
                        (("ocamlfind",
                           [
                              ...
                              "-add";
                              "re2";
                              "_build/lib/libre2_stubs.a";
                              "-dll";
                              "_build/lib/dllre2_stubs.so"
                           ])))
                 ]
            };
          uninstall_custom =
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "1\238\248\131%\027\027\b\188\001\249\127\235\002h\"";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
