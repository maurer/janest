(* OASIS_START *)
(* DO NOT EDIT (digest: 4878f7b84ad08ba05d308603849299ee) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/bin_prot";
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Pa_bin_prot"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "bin_prot";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "bin_prot";
                           InternalLibrary "pa_bin_prot";
                           FindlibPackage
                             ("oUnit",
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "mac_test.ml"});
               Test
                 ({
                     cs_name = "mac_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.4";
     oasis_digest =
       Some "\230\158|\208o_\004\150\173\144\198\1540\151\225\199";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
